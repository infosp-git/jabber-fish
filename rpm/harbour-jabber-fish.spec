Name: harbour-jabber-fish
Version: 0.0.1
Release:	1%{?dist}
Summary: jabber-fish - XMPP Client for Sailfish OS

Group: Qt/Qt
License: GPL
URL: https://github.com/infosp-git/jabber-fish
...
install -p %(pwd)/resources/harbour-jabber-fish.desktop %{buildroot}%{_datadir}/applications/%{name}.desktop
install -p %(pwd)/resources/harbour-jabber-fish-message.conf %{buildroot}%{_datadir}/lipstick/notificationcategories/%{name}-message.conf
